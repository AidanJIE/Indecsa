...
public class c_h_proyecto_especialidad_CDMX extends Fragment {
    ...
    public c_h_proyecto_especialidad_CDMX() {
    ...
    private void irAProyectoEspecialidad(String especialidad) {
        ...
        switch (especialidad) {
            case "Obra":
                siguienteFragment = new c_h_proyecto_obra_CDMX();
                break;
            case "Remodelacion":
                siguienteFragment = new c_h_proyecto_remodelacion_CDMX();
                break;
            case "Venta Mobiliario":
                siguienteFragment = new c_h_proyecto_venta_mobiliario_CDMX();
                break;
